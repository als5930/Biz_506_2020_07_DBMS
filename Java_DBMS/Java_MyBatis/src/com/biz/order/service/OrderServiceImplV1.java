...
public class OrderServiceImplV1 implements OrderService {
	...
	public OrderServiceImplV1() {
		...
		/*
		 * openSession() 매개변수 true : insert, update, delete수행한 후 자동으로 Auto Commit을 수행
		 * CUD 수행한 후 결과를 확실히 저장하라
		 * 
		 */
	...
	@Override
	public OrderVO finBySeq(long seq) {
	...
	public int insert(OrderVO orderVO) {
		...
		// 데이터를 추가할때 추가하는 시점에 시간을 컴퓨터의 시계에서 참조하여 만들자
